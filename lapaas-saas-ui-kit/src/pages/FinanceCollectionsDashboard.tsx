...
import { BarChart3, TrendingUp, AlertCircle, Phone, MessageSquare, Eye, Plus } from 'lucide-react';
...
export default function FinanceCollectionsDashboard() {
