 ...
 */
router.post('/org-modules', (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/org-modules/:org_id', (req: Request, res: Response) => {
  try {
 ...
 */
router.post('/ai-credits', (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/ai-credits/:org_id', (req: Request, res: Response) => {
  try {
    const { org_id } = req.params;
 ...
 */
router.put('/ai-credits/:org_id', (req: Request, res: Response) => {
  try {
    const { org_id } = req.params;
 ...
 */
router.get('/subscriptions/:org_id', (req: Request, res: Response) => {
  try {
    const { org_id } = req.params;
 ...
 */
router.get('/payments/:org_id', (req: Request, res: Response) => {
  try {
    const { org_id } = req.params;
