 ...
 */
router.get('/policy/:org_id', (req: Request, res: Response) => {
  try {
 ...
 */
router.get('/templates/:org_id', (req: Request, res: Response) => {
  try {
    const { org_id } = req.params;
 ...
 */
router.get('/agent/:org_id', (req: Request, res: Response) => {
  try {
    const { org_id } = req.params;
 ...
 */
router.get('/agent/:org_id/logs', (req: Request, res: Response) => {
  try {
    const { org_id } = req.params;
 ...
 */
router.get('/automations/:org_id', (req: Request, res: Response) => {
  try {
    const { org_id } = req.params;
